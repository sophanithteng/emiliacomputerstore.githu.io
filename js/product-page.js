(function () {
  function getActivePageCategory(pathname) {
    ...
    if (
      path.startsWith("msi_") ||
      path.startsWith("vector_") ||
      path.startsWith("raider_")
    )
      return "msi";
    if (
      path.startsWith("asus_") ||
      path.startsWith("dell_") ||
      path.startsWith("nb_dell_")
    )
      return "asus";
          ...
          document.querySelectorAll("#navbar-placeholder a").forEach((link) => {
            ...
            if (href === "index.html" || href === "/index.html") {
              if (window.location.hostname.includes("github.io")) {
                link.setAttribute(
                  "href",
                  "/emiliacomputerstore.githu.io/index.html",
                );
              } else {
